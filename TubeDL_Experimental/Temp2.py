...
class YouTubeDownloader:
    def __init__(self, root):
        ...
        style.configure("green.Horizontal.TProgressbar", troughcolor='gray', background='green', bordercolor='black', lightcolor='green', darkcolor='green')
    ...
    def clean_title(self, title):
        ...
        # Split into words and take the first three
